...
// Create mentor
router.post("/create-mentor", validate(mentorSchema), mentorController.createMentorController);
router.get("/", mentorController.getAllMentorsController);
router.get("/:id", mentorController.getAMentorController);
router.patch("/update/:id", validate(mentorSchema.partial()), mentorController.updateMentorController);
